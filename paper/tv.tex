...
The expression \code{ \textbf{event} [\anyevent{A}(v)] } 
...
We remark additional process constructs (e.g. if-then-else, while, etc.) 
can be defined using the above. In this setting, clock variables are 
