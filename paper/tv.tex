...
void process (int i)
/* req  d1<d2,  emp 
   ens  true, (Update(i)#d1.emp#d2.([x=i]Critical(i).Exit(i) \/ emp))^* */
{
  [x=-1] 
...
\figref{fig:Syntax_of_Types_and_Effects} Effects is 
 a conditioned time  event sequence \code{\pure{\pi},  es} or a disjunction of two effects $es_1 \vee es_2$.
...
%%     Concatenate        %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
&\code{d, s, \varphi \models \pure{\pi}, (es_1\cdot es_2)}  
&\m{iff}\quad & \exists \code{\varphi_1,\varphi_2}. \  
\code{ \varphi_1 {\lappend} \varphi_2 {=} \varphi}\ and\ 
\exists \code{d_1,d_2}. \  
\code{ d_1 {+} d_2 {=} d} \\
&&& \qquad  s.t. \ \code{d_1, s, \varphi_1 {\models} \pure{\pi}  , es_1 }
\ and \ \code{d_2, s, \varphi_2 {\models} \pure{\pi}  , es_2 }\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%    disjunction         %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
&\code{d, s, \varphi \models \pure{\pi}  , (es_1{\vee}es_2)}  
&\m{iff}\quad & \code{d, s, \varphi \models \pure{\pi}  , es_1 } 
\ or\ \code{d, s, \varphi \models \pure{\pi}  , es_2 } \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%    parallel         %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
&\code{d, s, \varphi \models \pure{\pi} , (ev_1{\cdot}es_1)||(ev_2{\cdot}es_2)}  
&\m{iff}\quad & \code{d, s, \varphi \models \pure{\pi}  , ev_1{\cdot} (es_1||(ev_2{\cdot}es_2)) } 
\ or\ \code{d, s, \varphi \models \pure{\pi}  , ev_2{\cdot}((ev_1{\cdot}es_1)||es_2)  } \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%    parallel  2        %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\code{\frac{  \vdash \{  \empt, True \} 
 \ e \  \{ \effect, \Pi \} \quad  \vdash\effect \CONTAIN  
