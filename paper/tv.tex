...
We built the axiom system on top of a complete axiom system \code{F_1}, from (A1) to (A10), suggested by \cite{DBLP:journals/jacm/Salomaa66}, 
...
the front-end forward verifier for conformance. 
