...
\exists \code{d_1,d_2}. \  
\code{ d_1 {+} d_2 {=} d} \ 
  and \ \code{d_1, s, \varphi_1 {\models} \pure{\pi}  , \es_1 }
...
& & &  \code{\llbracket \pure{\pi}  , t {>} 0 \rrbracket_{s} {=}  
\pure{True} }, 
\  \exists \code{\varphi_1,\varphi_2}. \  \code{ \varphi_1 \lappend  \varphi_2 {=} \varphi}
\  and \ \code{d, s, \varphi_1 \models \pure{\pi}  , \es } \\
& & & \quad and \ \code{d, s, \varphi_2  \models (\pure{\pi}  , t {>} 0) \wedge  \es^{t\text{-}1} } \\
&\code{d, s, \varphi \models \pure{\pi}, \es^\star}  &\m{iff}\quad & there\ exist\ \code{\varphi_1,\varphi_2}
\   and \  \code{ \varphi_1 {+}{+} \varphi_2 {=} \varphi} 
 \  and \ \code{d, s, \varphi_1 \models \pure{\pi} , \es } 
 \   and \ \code{d, s, \varphi_2 \models \pure{\pi} , \es^\star }\\
