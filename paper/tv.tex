...
\infer[dashed]1[{\textcircled{4}\siderule{\codeme{[PROVE]}}}]{
  \code{
...
\infer[dashed]1[{\textcircled{7}\siderule{\codeme{[REOCCUR]}}}]{
  \code{
    \textcolor {
      darkred}{
...
\infer[dashed]1[{\textcircled{6}\siderule{\codeme{[UNFOLD]}}}]{
  \code{
    \textcolor {darkred}{t_L^1{+}t_L^2{=}t_L  \wedge  t_R{=}t_R^1{+}t_R^2} \wedge 
...
%As explained in \secref{subsec:Specification_language}, t
