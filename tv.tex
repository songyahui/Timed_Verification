...
Here, \code{\#} is the novel operator specifying the \emph{real-time} 
...
\emph{exact} transition system, our timed effects define a set 
(possibly infinite) of exact transition systems. 
